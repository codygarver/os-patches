...
{
  return (GDBusInterfaceInfo *) &_whoopsie_preferences_interface_info;
}
  ...
  GParamSpec   *pspec)
{
  ...
  g_dbus_proxy_call (G_DBUS_PROXY (object),
    ...
    G_DBUS_CALL_FLAGS_NONE,
    -1,
    NULL, (GAsyncReadyCallback) whoopsie_preferences_proxy_set_property_cb, (gpointer) info);
  g_variant_unref (variant);
}
  ...
  GVariant *parameters)
{
  ...
  guint n;
  guint signal_id;
  info = (_ExtendedGDBusSignalInfo *) g_dbus_interface_info_lookup_signal ((GDBusInterfaceInfo *) &_whoopsie_preferences_interface_info, signal_name);
  if (info == NULL)
    return;
  ...
  const gchar *const *invalidated_properties)
{
  ...
  while (g_variant_iter_next (iter, "{&sv}", &key, NULL))
    {
      info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_whoopsie_preferences_interface_info, key);
  ...
  for (n = 0; invalidated_properties[n] != NULL; n++)
    {
      info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_whoopsie_preferences_interface_info, invalidated_properties[n]);
...
{
  proxy->priv = G_TYPE_INSTANCE_GET_PRIVATE (proxy, TYPE_WHOOPSIE_PREFERENCES_PROXY, WhoopsiePreferencesProxyPrivate);
...
whoopsie_preferences_proxy_class_init (WhoopsiePreferencesProxyClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (WhoopsiePreferencesProxyPrivate));
  ...
  gpointer user_data)
{
  ...
  GVariant *ret;
  ret = NULL;
  info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_whoopsie_preferences_interface_info, property_name);
  g_assert (info != NULL);
...
whoopsie_preferences_skeleton_dbus_interface_get_info (GDBusInterfaceSkeleton *skeleton)
{
  return whoopsie_preferences_interface_info ();
}

static GDBusInterfaceVTable *
whoopsie_preferences_skeleton_dbus_interface_get_vtable (GDBusInterfaceSkeleton *skeleton)
{
...
{
  skeleton->priv = G_TYPE_INSTANCE_GET_PRIVATE (skeleton, TYPE_WHOOPSIE_PREFERENCES_SKELETON, WhoopsiePreferencesSkeletonPrivate);
...
whoopsie_preferences_skeleton_class_init (WhoopsiePreferencesSkeletonClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (WhoopsiePreferencesSkeletonPrivate));
